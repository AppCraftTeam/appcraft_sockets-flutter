...
import 'package:example/presentation/pages/mobile/widget/mobile_message_layout.dart';
...
class SingleChatPageMobile extends StatefulWidget {
  ...
  const SingleChatPageMobile({Key? key, required this.uid, required this.userName})
      : super(key: key);
...
class _SingleChatPageMobileState extends State<SingleChatPageMobile> {
  ...
  @override
  void initState() {
    var communicationCubit = getIt<CommunicationCubit>();
    communicationCubit.getTextMessages();
    super.initState();
  }
          ...
          child: ConstrainedBox(
            ...
            child: Scrollbar(
              child: TextField(
                ...
                maxLines: null,
                decoration:
                    const InputDecoration(border: InputBorder.none, hintText: "Type message..."),
              ),
            ),
          ),
        );
